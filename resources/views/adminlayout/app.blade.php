...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href=""><i class="fa fa-list"></i> <span>Contacts</span></a></li>
                <li><a href=""><i class="fa fa-book"></i> <span>Settings</span></a></li>
                <li><a href=""><i class="fa fa-book"></i> <span>Posts</span></a></li>
                <li><a href=""><i class="fa fa-users"></i> <span>clients</span></a></li>
                <li><a href=""><i class="fa fa-list"></i> <span>roles</span></a></li>
                <li><a href=""><i class="fa fa-users"></i> <span>users</span></a></li>
                <li><a href=""><i class="fa fa-list"></i> <span>donations</span></a></li>
                <li><a href=""><i class="fa fa-list"></i> <span>reset-password</span></a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{url('/admin/users')}}"><i class="fa fa-dashboard"></i> Home</a></li>
